...
(function (states) {
    ...
    states.playStateLvl3 = playStateLvl3;
    // play state Function
    function playLvl3() {
        ...
        monsterBoss = new objects.MonsterBoss(assets.getResult("monsterBoss"), stage, game);
        // Show Cursor
        stage.cursor = "none";
        ...
        for (var i = 0; i < constants.MONSTER_BOSS_MISSILE_NUM; i++) {
            bossMissileArr[i] = new objects.MonsterBossMissile(assets.getResult("monsterBossMissile"), stage, game, monsterBoss);
        }
        // Display Scoreboard
    ...
    states.playLvl3 = playLvl3;
})(states || (states = {}));
//# sourceMappingURL=playlvl3.js.map
